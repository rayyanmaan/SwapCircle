...
This keeps data inside Backend/data/items.json so behavior is deterministic and
contained to the Backend/ folder. It's intentionally minimal and synchronous.
"""
import json
...
# simple thread lock to avoid races in tests
